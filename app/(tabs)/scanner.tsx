  ...
  const startScanningWithImage = async (uri: string, base64: string | null = null) => {
    ...
    try {
      ...
      Alert.alert(
        ...
        isCapacityError
          ? 'A foto foi salva. Você pode tentar novamente ou continuar com dados locais de demonstração.'
          : err instanceof GeminiServiceError ? err.message : 'Verifique a configuração da IA e tente novamente.',
        [
          { text: 'Cancelar', style: 'cancel' },
          { text: 'Usar demonstração', onPress: useDemoResult },
        ]
      );
    }
  };
